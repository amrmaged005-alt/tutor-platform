...
class AppLocalizations {
  ...
  static final _values = <String, Map<AppLang, String>>{
    ...
    'common.student': {AppLang.en: 'Student', AppLang.ar: 'طالب'},
    'common.emailExample': {
    ...
    'classes.full': {AppLang.en: 'Full', AppLang.ar: 'مكتمل'},
    'classes.onlyLeft': {
      AppLang.en: 'Only {count} left',
      AppLang.ar: 'متبقي {count} فقط',
    },
    'classes.enrolled': {AppLang.en: 'enrolled', AppLang.ar: 'مشترك'},
    'classes.duration': {AppLang.en: 'Duration', AppLang.ar: 'المدة'},
    'classes.level': {AppLang.en: 'Level', AppLang.ar: 'المستوى'},
    ...
    'dashboard.earnings': {AppLang.en: 'Earnings', AppLang.ar: 'الأرباح'},
    'dashboard.thisMonth': {AppLang.en: 'This month', AppLang.ar: 'هذا الشهر'},
    'dashboard.pending': {AppLang.en: 'Pending', AppLang.ar: 'قيد الانتظار'},
    'dashboard.collected': {AppLang.en: 'Collected', AppLang.ar: 'محصل'},
    'dashboard.attendance': {AppLang.en: 'Attendance', AppLang.ar: 'الحضور'},
    'dashboard.roster': {
      AppLang.en: 'Student roster',
      AppLang.ar: 'قائمة الطلاب',
    },
    'dashboard.content': {
      AppLang.en: 'Post-class content',
      AppLang.ar: 'محتوى ما بعد الحصة',
    },
    'dashboard.revenueByTutor': {
      AppLang.en: 'Revenue by tutor',
      AppLang.ar: 'الإيرادات حسب المدرس',
    },
    'dashboard.revenueBySubject': {
      AppLang.en: 'Revenue by subject',
      AppLang.ar: 'الإيرادات حسب المادة',
    },
    'dashboard.calendar': {
      AppLang.en: 'Upcoming calendar',
      AppLang.ar: 'تقويم المواعيد',
    },
    'manage.addClass': {AppLang.en: 'Add class', AppLang.ar: 'إضافة فصل'},
    'manage.editClass': {AppLang.en: 'Edit class', AppLang.ar: 'تعديل الفصل'},
    'manage.deleteClass': {AppLang.en: 'Delete class', AppLang.ar: 'حذف الفصل'},
    'manage.deleteWarning': {
      AppLang.en: 'This will cancel all bookings for this class. Are you sure?',
      AppLang.ar: 'سيتم إلغاء كل حجوزات هذا الفصل. هل أنت متأكد؟',
    },
    'manage.publish': {AppLang.en: 'Publish', AppLang.ar: 'نشر'},
    'manage.draft': {AppLang.en: 'Save draft', AppLang.ar: 'حفظ كمسودة'},
    'manage.active': {AppLang.en: 'Active', AppLang.ar: 'نشط'},
    'manage.drafts': {AppLang.en: 'Drafts', AppLang.ar: 'مسودات'},
    'manage.completed': {AppLang.en: 'Completed', AppLang.ar: 'مكتمل'},
    'manage.assignTutor': {
      AppLang.en: 'Assigned tutor',
      AppLang.ar: 'المدرس المسند',
    },
    'manage.photoPlaceholder': {
      AppLang.en: 'Photo upload placeholder',
      AppLang.ar: 'مكان رفع الصورة',
    },
    'manage.formRequired': {AppLang.en: 'Required', AppLang.ar: 'مطلوب'},
    'manage.title': {AppLang.en: 'Title', AppLang.ar: 'العنوان'},
    'manage.description': {AppLang.en: 'Description', AppLang.ar: 'الوصف'},
    'manage.price': {AppLang.en: 'Price EGP', AppLang.ar: 'السعر بالجنيه'},
    'manage.seats': {AppLang.en: 'Total seats', AppLang.ar: 'إجمالي المقاعد'},
    'manage.dateTime': {
      AppLang.en: 'Date and time',
      AppLang.ar: 'التاريخ والوقت',
    },
    'manage.minutes': {AppLang.en: 'Minutes', AppLang.ar: 'الدقائق'},
    'manage.locationLink': {
      AppLang.en: 'Location or meeting link',
      AppLang.ar: 'المكان أو رابط الاجتماع',
    },
    'manage.subject': {AppLang.en: 'Subject', AppLang.ar: 'المادة'},
    'manage.sessionType': {AppLang.en: 'Session type', AppLang.ar: 'نوع الحصة'},
    'manage.level': {AppLang.en: 'Level', AppLang.ar: 'المستوى'},
    'manage.notes': {AppLang.en: 'Session notes', AppLang.ar: 'ملاحظات الحصة'},
    'manage.recording': {
      AppLang.en: 'Recording URL',
      AppLang.ar: 'رابط التسجيل',
    },
    'manage.homework': {AppLang.en: 'Homework file', AppLang.ar: 'ملف الواجب'},
    'manage.exportCsv': {AppLang.en: 'CSV', AppLang.ar: 'CSV'},
