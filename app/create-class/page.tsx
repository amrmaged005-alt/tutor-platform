    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#0f172a", fontFamily: "system-ui, sans-serif", padding: "2rem" }}>
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "1.25rem" }}>
          ...
          <input
            style={inputStyle}
            placeholder="e.g. Physics – Mechanics & Waves (Grade 11)"
            value={form.title}
        ...
        {/* ── Section: Curriculum & Grade ── */}
        <SectionTitle>Curriculum & Level</SectionTitle>
        ...
        {/* ── Section: Format & Language ── */}
        <SectionTitle>Format & Language</SectionTitle>
        ...
        <div style={{ marginBottom: "1.75rem" }}>
          ...
          <input
            style={inputStyle}
            placeholder="e.g. Saturday & Monday, 5:00 PM"
            value={form.schedule}
