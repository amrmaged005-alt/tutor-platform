...
export default async function BookingConfirmedPage({
  ...
  // Load the booking with its class and tutor/center info
  ...
  // Security: make sure this booking belongs to the logged-in student
  ...
  // Determine what to show based on payment type and status
      ...
      <div style={{ maxWidth: 520, width: "100%", textAlign: "center" }}>
        ...
        <div
          style={{
            ...
            height: 80,
            borderRadius: "50%",
            backgroundColor: isFailed ? "#1c0a0a" : "#052e16",
            border: `2px solid ${isFailed ? "#f87171" : "#4ade80"}`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            fontSize: 36,
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            {/* Show commission breakdown only for online paid bookings */}
            {isOnline && isPaid && (
              <div style={{ display: "flex", justifyContent: "space-between" }}>
